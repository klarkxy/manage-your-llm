...
const messages = {
  ...
  settings: {
    ...
    publicEndpoints: {
      ...
      basePathHelp: 'Префикс URL для клиентских эндпоинтов. По умолчанию `/v1` подходит для большинства LLM-клиентов.',
      restartNote: 'Изменение базового пути требует перезапуска сервера, прежде чем новый URL станет активным.',
      save: 'Сохранить',
      saved: 'Публичные эндпоинты сохранены',
      messages: 'Anthropic Messages',
      chatCompletions: 'OpenAI Chat Completions',
      responses: 'OpenAI Responses',
      models: 'Список моделей',
