...
const messages: Messages = {
  ...
  overview: {
    ...
    publicEndpoints: {
      title: '公共端点',
      caption: '把下列 URL 提供给将调用 ModelHarbor 的应用:',
      basePathLabel: '基础路径',
      baseUrlLabel: '基础 URL',
  ...
  modelGroups: {
    ...
    toast: {
      ...
      deleted: '已删除',
      refreshed: '自动组快照已刷新',
      loadedMore: '已新增 {count} 个成员',
      noMoreMatches: '当前 preset 下已没有更多匹配的公共模型',
    ...
    detail: {
      title: '模型组',
      preset: '预设: {preset}',
      lastRefreshed: '上次刷新: {at}',
      loadMore5: '再加载 5 个',
      noMembers: '暂无成员 — 刷新自动组以填充。',
    },
    validation: {
      required: '名称为必填项',
    },
  ...
  settings: {
    ...
    publicEndpoints: {
      title: '公共端点',
      basePath: '基础路径',
      basePathHelp: '面向客户端的端点 URL 前缀。默认 `/v1` 兼容大多数 LLM 客户端。',
      restartNote: '修改基础路径后需要重启服务器,新 URL 才会生效。',
      save: '保存',
      saved: '公共端点已保存',
      messages: 'Anthropic Messages',
      chatCompletions: 'OpenAI Chat Completions',
