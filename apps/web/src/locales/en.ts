const messages = {
  ...
  providers: {
    ...
    anthropic: 'Anthropic (International)',
    deepseek: 'DeepSeek (International)',
    moonshot: 'Moonshot (Kimi) (International)',
    'minimax-intl': 'MiniMax (International)',
    openrouter: 'OpenRouter (International)',
    'opencode-go': 'OpenCode Go (International)',
    'opencode-zen': 'OpenCode Zen (International)',
    groq: 'Groq (International)',
    together: 'Together AI (International)',
    cerebras: 'Cerebras (International)',
    fireworks: 'Fireworks AI (International)',
    xai: 'xAI (Grok) (International)',
    qwen: 'Alibaba Qwen (DashScope China)',
    'qwen-intl': 'Alibaba Qwen (DashScope International)',
    zhipu: 'Zhipu GLM (China)',
    'zhipu-coding': 'Zhipu GLM Coding Plan (China)',
    'moonshot-cn': 'Moonshot (Kimi) (China)',
    minimax: 'MiniMax (China)',
    siliconflow: 'SiliconFlow (China)',
    baichuan: 'Baichuan (China)',
    bytedance: 'ByteDance Volcano Ark (China)',
    hunyuan: 'Tencent Hunyuan (China)',
    qianfan: 'Baidu Qianfan (China)',
