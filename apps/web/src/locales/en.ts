const messages = {
  ...
  overview: {
    ...
    chartsEmpty: 'No usage recorded yet.',
    requestsChart: {
  ...
  modelGroups: {
    ...
    toast: {
      ...
      loadedMore: 'Added {count} more members',
      noMoreMatches: 'No more public models match this preset',
    ...
    detail: {
      ...
      loadMore5: 'Load 5 more',
      noMembers: 'No members yet — refresh auto to populate.',
    },
    validation: {
      required: 'Name is required',
    },
