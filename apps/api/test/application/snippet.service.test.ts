...
function makeSettings(publicBaseUrl?: string, gatewayBasePath?: string): AdminSettingsRow {
  return {
    id: 'settings',
    ...
    gatewayBasePath: gatewayBasePath ?? '/v1',
...
describe('SnippetService', () => {
  ...
  it('builds gateway url from public base url and gateway base path', () => {
    const url = service.buildGatewayUrl(makeSettings('https://myllm.example.com', '/v1'));
