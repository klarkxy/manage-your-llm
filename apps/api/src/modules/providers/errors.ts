...
import type { NormalizedProviderError, ProviderErrorContext, ProviderHttpResponse } from "./types.js";
...
export function emptyProviderError(): NormalizedProviderError {
  return { category: "provider_unknown", providerMessage: null, providerCode: null, upstreamStatus: 0 };
}
...
export function providerErrorToNormalized(
...
export function extractProviderErrorFields(bodyJson: unknown): { message: string | null; code: string | null } {
