...
export const PROVIDER_TYPES = ["anthropic_compatible", "openai_compatible"] as const satisfies readonly ProviderType[];
...
export const publicModelCandidates = sqliteTable(
  ...
  (t) => [
    uniqueIndex("public_model_candidate_unique").on(t.publicModelId, t.upstreamKeyId, t.realModelName),
...
export const stickyBindings = sqliteTable(
  ...
  (t) => [
    uniqueIndex("sticky_binding_unique").on(t.appId, t.consumerKeyId, t.requestedTargetName, t.conversationFingerprint),
