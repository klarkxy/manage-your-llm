...
export const settingsSchema = z.object({
  ...
  upstreamCooldownBaseMs: z.number(),
  upstreamCooldownMaxMs: z.number(),
...
export const updateSettingsRequestSchema = z.object({
  ...
  upstreamCooldownBaseMs: z.number().int().min(1000).optional(),
  upstreamCooldownMaxMs: z.number().int().min(1000).optional(),
