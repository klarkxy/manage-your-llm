...
export const PROVIDER_PRESETS: readonly ProviderDescriptor[] = [
  preset({
    ...
    branding: { icon: '✨' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://apihub.agnes-ai.com/v1', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    endpoints: [{ protocol: 'anthropic', baseUrl: 'https://api.anthropic.com', providerType: 'anthropic_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '🌊' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://api.baichuan-ai.com', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '🧠' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://api.cerebras.ai', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    authStrategies: { default: 'codex_oauth', available: ['codex_oauth', 'pat'] } as ProviderDescriptorAuthStrategies,
  ...
  preset({
    ...
    authStrategies: { default: 'coze_oauth_jwt', available: ['coze_oauth_jwt', 'pat'] } as ProviderDescriptorAuthStrategies,
  ...
  preset({
    ...
    branding: { icon: '🐋' },
    endpoints: [
      { protocol: 'anthropic', baseUrl: 'https://api.deepseek.com/anthropic', providerType: 'anthropic_compatible' },
      { protocol: 'openai', baseUrl: 'https://api.deepseek.com', providerType: 'openai_compatible' },
    ],
  ...
  preset({
    ...
    branding: { icon: '🎆' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://api.fireworks.ai/inference', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '⚡' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://api.groq.com/openai', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '🐧' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://api.hunyuan.cloud.tencent.com', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '💻' },
    endpoints: [{ protocol: 'anthropic', baseUrl: 'https://api.kimi.com/coding', providerType: 'anthropic_compatible' }],
  ...
  preset({
    ...
    branding: { icon: 'Ⓜ️' },
    endpoints: [
      { protocol: 'anthropic', baseUrl: 'https://api.minimax.io/anthropic', providerType: 'anthropic_compatible' },
  ...
  preset({
    ...
    branding: { icon: 'Ⓜ️' },
    endpoints: [
      { protocol: 'anthropic', baseUrl: 'https://api.minimaxi.com/anthropic', providerType: 'anthropic_compatible' },
      { protocol: 'openai', baseUrl: 'https://api.minimaxi.com', providerType: 'openai_compatible' },
    ],
  ...
  preset({
    ...
    branding: { icon: '🌙' },
    endpoints: [
      { protocol: 'anthropic', baseUrl: 'https://api.moonshot.cn/anthropic', providerType: 'anthropic_compatible' },
  ...
  preset({
    ...
    branding: { icon: '🌙' },
    endpoints: [
      { protocol: 'anthropic', baseUrl: 'https://api.moonshot.ai/anthropic', providerType: 'anthropic_compatible' },
  ...
  preset({
    ...
    endpoints: [{ protocol: 'openai', baseUrl: 'https://api.openai.com', providerType: 'openai_compatible' }],
  ...
  preset({
    id: 'opencode-go',
    metadata: { displayName: 'OpenCode Go' },
    branding: { icon: '🐙' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://opencode.ai/zen/go/v1', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '🐙' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://opencode.ai/zen/v1', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '🌐' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://openrouter.ai/api', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '🌸' },
    endpoints: [
      { protocol: 'openai', baseUrl: 'https://dashscope-intl.aliyuncs.com/compatible-mode', providerType: 'openai_compatible' },
    ],
  ...
  preset({
    ...
    branding: { icon: '🌸' },
    endpoints: [
      { protocol: 'openai', baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode', providerType: 'openai_compatible' },
    ],
  ...
  preset({
    ...
    branding: { icon: '💧' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://api.siliconflow.cn/v1', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '⬆️' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://api.stepfun.com', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '🤝' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://api.together.xyz', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '🚀' },
    endpoints: [{ protocol: 'openai', baseUrl: 'https://api.x.ai', providerType: 'openai_compatible' }],
  ...
  preset({
    ...
    branding: { icon: '🧬' },
    endpoints: [
      { protocol: 'anthropic', baseUrl: 'https://open.bigmodel.cn/api/anthropic', providerType: 'anthropic_compatible' },
      {
        protocol: 'openai',
