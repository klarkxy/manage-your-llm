...
- [ ] P4-010 Implement Anthropic SSE passthrough/normalizer
...
- [ ] P4-011 Implement OpenAI Chat SSE passthrough/normalizer
...
- [ ] P4-012 Implement Responses SSE passthrough/normalizer
...
- [ ] P4-021 Implement first-token timeout
  - Depends on: P4-020
...
- [ ] P4-022 Implement committed-stream behavior
  - Depends on: P4-021
...
- [ ] P4-023 Implement stream usage collection
  - Depends on: P4-010, P4-011, P4-012
...
- [ ] P4-025 Wire streaming gateway routes
...
- [ ] P4-053 Implement manual model ping updates
  - Depends on: P2-034
...
- [ ] P4-060 Implement maintenance service
...
- [ ] P4-063 Add quota window maintenance
