...
- [ ] P3-001 Add gateway route registration
  - Depends on: P2-071
...
- [ ] P3-002 Implement Consumer Key gateway guard
...
- [ ] P3-020 Implement target resolution service
  - Depends on: P1-034
...
- [ ] P3-021 Wire AccessPolicyService into gateway
...
- [ ] P3-030 Implement public model candidate expansion
...
- [ ] P3-031 Implement model group candidate expansion
  - Depends on: P3-030
...
- [ ] P3-034 Implement candidate filter pipeline
...
- [ ] P3-035 Implement endpoint health sort hook
...
- [ ] P3-040 Implement conversation fingerprint
  - Depends on: P0-013
...
- [ ] P3-041 Implement sticky lookup and reorder
...
- [ ] P3-042 Implement session sticky lookup and reorder
...
- [ ] P3-050 Implement `RoutingDecisionService`
...
- [ ] P3-060 Define provider adapter interface
...
- [ ] P3-061 Implement OpenAI-compatible adapter
  - Depends on: P3-060
...
- [ ] P3-062 Implement Anthropic-compatible adapter
  - Depends on: P3-060
...
- [ ] P3-063 Implement Responses-compatible request/response handling
  - Depends on: P3-061
...
- [ ] P3-064 Implement provider adapter registry
...
- [ ] P3-065 Implement upstream auth resolver
...
- [ ] P3-066 Implement upstream sender
  - Depends on: P3-060
...
- [ ] P3-070 Implement `GatewayExecutionService`
...
- [ ] P3-071 Implement final error aggregation
  - Depends on: P3-070
...
- [ ] P3-072 Implement protocol response mappers
  - Depends on: P3-070
...
- [ ] P3-080 Implement trace side effects
...
- [ ] P3-083 Implement sticky upsert on success
...
- [ ] P3-084 Implement cooldown and breaker result hooks
  - Depends on: P1-035, P3-070
...
- [ ] P3-090 Wire non-streaming gateway routes
