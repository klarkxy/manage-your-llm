...
- [ ] P1-001 Add Drizzle and SQLite client
  - Depends on: P0-030
...
- [ ] P1-015 Add routing state tables
  - Depends on: P1-002
...
- [ ] P1-016 Add observability tables
  - Depends on: P1-002
...
- [ ] P1-030 Implement admin user repository
...
- [ ] P1-050 Implement password/session primitives
  - Depends on: P1-030
...
- [ ] P1-056 Implement BackupService low-level operations
  - Depends on: P1-039
...
- [ ] P1-090 Add domain-data architecture notes
