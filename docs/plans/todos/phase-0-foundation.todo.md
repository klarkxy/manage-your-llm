...
- [x] P0-001 Create root workspace files
  - Depends on: none
...
- [x] P0-003 Add shared TypeScript config
  - Depends on: P0-001
...
- [x] P0-010 Create `packages/shared`
  - Depends on: P0-001
...
- [x] P0-014 Add provider capability helpers
  - Depends on: P0-013
...
- [x] P0-020 Create `packages/contracts`
  - Depends on: P0-001
...
- [x] P0-032 Add Fastify server shell
...
- [x] P0-052 Add Playwright skeleton
  - Depends on: P0-040
...
- [x] P0-054 Document local dev commands
